...
input_video_path = 'E:\\AR_Wayfinding_Project\\assets\\original\\2_turn left.mp4'
output_video_path = 'E:\\AR_Wayfinding_Project\\assets\\original\\back_Processed.mp4'
...
while cap.isOpened():
    ...
    direction_info = f"Direction: North by East, {start_angle:.2f} degrees from North"
